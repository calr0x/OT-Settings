...
OTNODERC=$(find /root -name $OTNODE_FILENAME -type f -not -path ~/.origintrail_noderc)
...
HOUSTON=$(find /root -name $HOUSTON_FILENAME -type f -not -path ~/.origintrail_noderc)
...
KADEMLIA_KEY=$(find /root -name $KADEMLIA_KEY_FILENAME -type f -path -type f -not -path ~/.origintrail_noderc)
