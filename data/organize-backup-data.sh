...
OTNODERC=$(find /root -name $OTNODE_FILENAME -type f -path ~/.origintrail_noderc -prune -o -printf '%h\n')
...
HOUSTON=$(find /root -name $HOUSTON_FILENAME -type f -path ~/.origintrail_noderc -prune -o -printf '%h\n')
...
IDENTITY=$(find /root -name $IDENTITY_FILENAME -type f -path ~/.origintrail_noderc -prune -o -printf '%h\n')
...
KADEMLIA=$(find /root -name $KADEMLIA_FILENAME -type f -path ~/.origintrail_noderc -prune -o -printf '%h\n')
...
KADEMLIA_KEY=$(find /root -name $KADEMLIA_KEY_FILENAME -type f -path ~/.origintrail_noderc -prune -o -printf '%h\n')
...
SYSTEMDB=$(find /root -name $SYSTEMDB_FILENAME -type f -path ~/.origintrail_noderc -prune -o -printf '%h\n')
...
XDAI_IDENTITY=$(find /root -name $XDAI_IDENTITY_FILENAME -type f -path ~/.origintrail_noderc -prune -o -printf '%h\n')
...
MIGRATIONS=$(find /root -name $MIGRATIONS_FILENAME -type d -path ~/.origintrail_noderc -prune -o -printf '%h\n')
